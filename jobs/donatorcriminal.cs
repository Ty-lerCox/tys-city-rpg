...
// Project                                :        CityRPG
// Author                                :        /Ty
// Description                                :        Donator Criminal Code file
// ============================================================

$CityRPG::jobs::name = "Donator Criminal";
$CityRPG::jobs::type = "donator";
$CityRPG::jobs::initialInvestment = 0;
$CityRPG::jobs::pay = 200;
$CityRPG::jobs::tools = "TacticalVestItem gc_PistolItem gc_SniperRifleItem";
