...
{
	AddDamageType("Pickaxe",   '<bitmap:Add-Ons/Gamemode_TysCityRPG/shapes/ci/pickaxe> %1',    '%2 <bitmap:Add-Ons/Gamemode_TysCityRPG/shapes/ci/pickaxe> %1', 0.5, 1);
	...
	datablock ItemData(CityRPGPickaxeItem)
	{
		...
		shapeFile		= "Add-Ons/Gamemode_TysCityRPG/shapes/pickaxe.2.dts";
		mass			= 1;
		density 		= 0.2;
		elasticity		= 0.2;
		friction		= 0.6;
		...
		uiName			= "Pickaxe";
		iconName		= "Add-Ons/Gamemode_TysCityRPG/shapes/ItemIcons/pickaxe";
		doColorShift	= false;
